    ...
    <header class="mobile-menu">
      <nav>
        ...
        <div class="liens">
          ...
          <a href="/fr/" onclick="closeMenu()" class="accueil" id="inactive">
            Accueil
          </a>
          <a
            href="/fr/tous-les-articles/"
          ...
          <a href="/fr/livres/" onclick="closeMenu()" class="livres inactive">
            Livres
          </a>
          <a
            href="/fr/le-saviez-vous/"
            onclick="closeMenu()"
